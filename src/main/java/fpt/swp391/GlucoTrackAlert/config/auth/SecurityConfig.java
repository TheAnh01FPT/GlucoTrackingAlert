        ...
        public SecurityFilterChain filterChain(HttpSecurity http, JwtAuthenticationFilter jwtAuthenticationFilter)
                ...
                http
                                ...
                                .authorizeHttpRequests(auth -> auth
                                                ...
                                                // 4. Phân quyền cho Thuốc & Đơn thuốc (Quy tắc cụ thể đặt trước
                                                // wildcard)
                                                .requestMatchers("/patient/medications").hasAnyRole("PATIENT", "ADMIN")
                                                .requestMatchers("/api/medications/prescriptions/*/cancel")
                                                .hasAnyRole("DOCTOR", "ADMIN")
                                                .requestMatchers("/api/medications/prescriptions")
                                                .hasAnyRole("DOCTOR", "ADMIN")
                                                .requestMatchers("/api/medications/prescriptions/**")
                                                .hasAnyRole("PATIENT", "DOCTOR", "ADMIN")
                                                ...
                                                .requestMatchers("/health-logs/doctor-view",
                                                                "/health-logs/doctor-chart")
                                                .hasAnyRole("ADMIN", "DOCTOR")
                                                .requestMatchers("/health-logs/kidney-risk/weekly")
                                                .hasAnyRole("PATIENT", "ADMIN", "DOCTOR")
                                                .requestMatchers("/health-logs/kidney-risk/weekly/**")
                                                .hasAnyRole("ADMIN", "DOCTOR")
                                                .requestMatchers("/health-logs/kidney-risk/doctor/**",
                                                                "/health-logs/kidney-risk/doctor/dashboard")
                                                .hasAnyRole("DOCTOR", "ADMIN")
                                                .requestMatchers("/health-logs/doctor-view/thresholds/**")
                                                .hasAnyRole("ADMIN", "DOCTOR")
                                                .requestMatchers("/api/health-logs/**")
                                                ...
                                                .hasAnyRole("ADMIN", "DOCTOR")
                                                .requestMatchers("/api/patient/**", "/api/patient")
                                                ...
                                                .requestMatchers(HttpMethod.GET, "/api/recommendations/patient/**")
                                                .hasAnyRole("PATIENT", "DOCTOR", "ADMIN")
                                                .requestMatchers("/api/recommendations/**").hasRole("DOCTOR")
                                                .requestMatchers("/api/notifications/**")
                                                .hasAnyRole("PATIENT", "DOCTOR", "ADMIN")

                                                // 9. Bảo vệ tài liệu/CCCD nhạy cảm trong uploads (Chỉ ADMIN, DOCTOR,
                                                // PATIENT được xem)
