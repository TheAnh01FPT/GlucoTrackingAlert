...
public class WeeklyReportServiceImpl implements WeeklyReportService {
    ...
    private WeeklySnapshot computeSnapshot(Patient patient, Long patientId, LocalDate weekStart, LocalDate weekEnd) {
        ...
        Optional<fpt.swp391.GlucoTrackAlert.model.healthlog.HealthThreshold> systolicThreshold = healthThresholdService.resolveThreshold(patientId, patient.getPatientType(), fpt.swp391.GlucoTrackAlert.enums.MetricType.SYSTOLIC);
        Optional<fpt.swp391.GlucoTrackAlert.model.healthlog.HealthThreshold> diastolicThreshold = healthThresholdService.resolveThreshold(patientId, patient.getPatientType(), fpt.swp391.GlucoTrackAlert.enums.MetricType.DIASTOLIC);
