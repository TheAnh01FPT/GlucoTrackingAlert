        ...
        try {
            ...
            if (response.getStatusCode() == HttpStatus.OK && response.getBody() != null) {
                ...
                if (rawRiskLevel != null) {
                    ...
                    if (lowerLevel.contains("critical") || (strokePct != null && strokePct >= 70)) {
                    ...
                    } else if (lowerLevel.contains("medium") || lowerLevel.contains("moderate") || (strokePct != null && strokePct >= 30)) {
                        mappedLevel = "MEDIUM";
